...
class Unet(nn.Module):
    def __init__(
        ...
        if self.model_output == 'logistic_pars':
            ...
            self.final_conv = nn.Conv2d(dim, self.out_dim * self.num_pixel_vals, 1),
    ...
    def forward(self, x, time, x_self_cond = None):
        ...
        x_onehot = F.one_hot(x.to(torch.int64), num_classes=self.num_pixel_vals)
        ...
        if self.model_output == 'logistic_pars':
            ...
            out = torch.tanh(loc + r), log_scale
        else:
